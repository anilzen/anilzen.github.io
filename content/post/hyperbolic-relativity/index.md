...
This construction generalizes to [curved spacetimes](../../publication/2007-zenginoglu-hyperboloidal-scri-fixing/). It's favorable for numerically solving wave equations because the coefficients don't depend on time. Some of the problems appearing in standard coordinates, such as the outer boundary and radiation extraction problems, [don't arise with this approach](../../publication/2010-zenginoglu-hyperboloidal-layers/) because we can solve the wave equation on the infinite spatial domain $\rho\in[0,1]$.
