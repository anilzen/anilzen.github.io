...
\begin{tikzpicture}[scale=3]
    ...
    % BOUNDING DIAGRAM
    \node[right, draw] at (0.4,1) {\small{$\tau=\pm\sqrt{t^2-r^2}$}};
    ...
    \tikzset{declare function={
        T(\t,\r)  = {\fpeval{1/pi*(atan(sqrt(\t**2+\r**2)+\r) + atan(sqrt(\t**2+\r**2)-\r))}};
        R(\t,\r)  = {\fpeval{1/pi*(atan(sqrt(\t**2+\r**2)+\r) - atan(sqrt(\t**2+\r**2)-\r))}};
    }}
    ...
    \foreach \i [evaluate={\t=\i/(\Nlines+1);}] in {0,...,\Nlines}{
